        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8 fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg" 
                className="medical-button bg-white text-primary hover:bg-white/90 text-lg px-8 py-6 border-transparent"
              >
                {t('hero.getStarted')}
          ...
          <div className="relative slide-up">
            <div className="relative">
              {/* Main Dashboard Card */}
              <div className="medical-card p-8 bg-white/95 backdrop-blur-sm medical-glow border-border">

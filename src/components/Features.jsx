      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {features.map((feature, index) => (
            <Card 
              ...
              className="medical-card hover:scale-105 transition-transform duration-300 slide-up border-border"
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {additionalFeatures.map((feature, index) => (
            <div 
              key={feature.title}
              className="medical-card p-6 space-y-4 hover:scale-105 transition-transform duration-300 fade-in border-border"

                  ...
                  {todayAppointments.map((appointment) => (
                    <div key={appointment.id} className="flex items-center justify-between p-4 border border-border rounded-lg">
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <Badge variant={appointment.status === 'completed' ? 'default' : 'secondary'} className="border-border">
                          {appointment.status === 'completed' ? 'पूर्ण' : 'आगामी'}
                        </Badge>
                        {appointment.status === 'upcoming' && (
                          <Button size="sm" className="medical-button bg-primary text-primary-foreground hover:bg-primary/90">
                            शुरू करें
                          </Button>
                        )}
                      </div>
                    ...
                    <div key={patient.id} className="flex items-center justify-between p-4 border border-border rounded-lg">
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="text-right">
                          ...
                          <Badge variant="outline" className="border-border">{patient.status}</Badge>
                        </div>
